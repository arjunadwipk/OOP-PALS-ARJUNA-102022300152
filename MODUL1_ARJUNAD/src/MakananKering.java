...
public class MakananKering {
    ...
    public void ShowKering () {
        System.out.print("Nama Makanan" + nama);
        System.out.print("Nama Jumlah" + jumlah);
        System.out.print("Nama Harga" + harga);
        System.out.print("Nama Brand" + brand);
